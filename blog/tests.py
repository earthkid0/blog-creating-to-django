...
class TestView(TestCase):
    ...
    def category_card_test(self,soup):
            ...
            self.assertIn(f'{self.categories_고추.name} ({self.categories_고추.post_set.count()})', categories_card.text)
            self.assertIn(f'{self.categories_옥수수.name} ({self.categories_옥수수.post_set.count()})', categories_card.text)
